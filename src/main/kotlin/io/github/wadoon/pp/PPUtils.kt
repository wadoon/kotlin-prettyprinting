...
object PPUtils {
    ...
    @JvmStatic
    private fun internalBreak(i: Int) =
        Document.IfFlat(blank(i), hardline)
     ...
     */
    @JvmStatic
    fun nest(indent: Int, x: Document) =
        Document.Nest(x.requirement(), indent, x)
    ...
    @JvmStatic
    @JvmOverloads
    fun Document.grouped(g: Boolean = true) =
        if (g) group(this) else this
    ...
    fun <A, B> List<A>.foldli(accu: B, f: (Int, B, A) -> B): B =
        foldIndexed(accu, f)
    ...
    /** @see jump */
    @JvmStatic
    fun Document.jumped(indent: Int = 0, space: Int = 0) =
        jump(this, indent, space)
    ...
    fun Document.surround(
        ...
        opening +
                nest(
                    indent, (breakOrSpaces(space) + this)
    ...
    fun softSurround(
        contents: Document,
        opening: Document = lparen,
        closing: Document = rparen,
        indent: Int = 0,
        space: Int = 0,
    ) = group(
